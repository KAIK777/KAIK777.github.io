...
function acao() {
	let modal = document.querySelector('.modal-containerlg');
...
var btncupom = document.querySelector('.btn-cupom');
var containercupom = document.querySelector('.cupom-container');

btncupom.addEventListener('click', function() {

	if(containercupom.style.display === 'block') {
		containercupom.style.display = 'none';
	} else {
		containercupom.style.display = 'block';
	}
});

function cancelCupom() {
  document.querySelector('.cupom-container').style.display = "none";
}
